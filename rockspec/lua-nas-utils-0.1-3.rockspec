...
build = {
   ...
   modules = {
      ...
      ["nas-utils.tests.test_nas_utils_crypto"] = "nas-utils/tests/test_nas_utils_crypto.lua",
      ["nas-utils.tests.test_nas_utils_helpers"] = "nas-utils/tests/test_nas_utils_helpers.lua",
      ["nas-utils.tests.test_nas_utils_strings"] = "nas-utils/tests/test_nas_utils_strings.lua"
   }
}
